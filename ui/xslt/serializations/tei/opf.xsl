...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xlink="http://www.w3.org/1999/xlink"
	xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns="http://www.idpf.org/2007/opf" version="2.0" exclude-result-prefixes="#all">
		...
		<package xmlns="http://www.idpf.org/2007/opf" unique-identifier="pub-id" version="3.0" xml:lang="en">
			...
			<manifest>
				...
				<xsl:for-each select="descendant::tei:div1">
					<item href="{parent::node()/local-name()}-{format-number(position(), '000')}.xhtml" id="{parent::node()/local-name()}-{format-number(position(), '000')}"
